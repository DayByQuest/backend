...
public class SearchGroupService {
    ...
    public SearchGroupService(final GroupDao groupDao) {
        this.groupDao = groupDao;
    }

    @Transactional(readOnly = true)
    public PageGroupsResponse invoke(final Long loginId, final String keyword, final NoOffsetIdPage page) {
        final LongIdList ids = groupDao.findIdsByNameLike(keyword, page);
